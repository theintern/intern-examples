...
define([ 'intern' ], function (intern) {
	var config = {
		...
		// Browsers to run integration testing against. Options that will be permutated are browserName, version,
		// platform, and platformVersion; any other capabilities options specified for an environment will be copied
		// as-is. Note that browser and platform names, and version number formats, may differ between cloud testing
		// systems.
		...
		loaderOptions: {
			...
			packages: [
				...
				{ name: 'backboneStorage', location: 'node_modules/backbone.localstorage' }
			]
		},
		...
		// A regular expression matching URLs to files that should not be included in code coverage analysis. Set to
		// `true` to completely disable code coverage.
